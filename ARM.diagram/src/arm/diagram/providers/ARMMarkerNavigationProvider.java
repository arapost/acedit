...
import arm.diagram.part.ARMDiagramEditorUtil;

/**
 * @generated
 */
public class ARMMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ARMDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ARMDiagramEditorUtil.selectElementsInDiagram(editor,
