 ...
 * @generated
 */
public class ARMViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return CaseEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& ARMVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ARMVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ARMVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!ARMElementTypes.isKnownElementType(elementType)
				...
				if (!CaseEditPart.MODEL_ID.equals(ARMVisualIDRegistry
		...
		return EvidenceAssertationEditPart.VISUAL_ID == visualID
				|| ClaimEditPart.VISUAL_ID == visualID
				|| ArgumentReasoningEditPart.VISUAL_ID == visualID
				|| InformationElementEditPart.VISUAL_ID == visualID
				|| CitiationElementEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ARMVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != ARMVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = ARMVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = ARMVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case EvidenceAssertationEditPart.VISUAL_ID:
			return createEvidenceAssertation_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case ClaimEditPart.VISUAL_ID:
			return createClaim_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case ArgumentReasoningEditPart.VISUAL_ID:
			return createArgumentReasoning_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case InformationElementEditPart.VISUAL_ID:
			return createInformationElement_2004(domainElement, containerView,
					index, persisted, preferencesHint);
		case CitiationElementEditPart.VISUAL_ID:
			return createCitiationElement_2005(domainElement, containerView,
					index, persisted, preferencesHint);
		case ArgumentEditPart.VISUAL_ID:
			return createArgument_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ARMVisualIDRegistry.getVisualID(elementTypeHint)) {
		case AssertedInferenceEditPart.VISUAL_ID:
			return createAssertedInference_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case AssertedContextEditPart.VISUAL_ID:
			return createAssertedContext_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case AssertedEvidenceEditPart.VISUAL_ID:
			return createAssertedEvidence_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createEvidenceAssertation_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ARMVisualIDRegistry
		...
		Node label5002 = createLabel(
				node,
				ARMVisualIDRegistry
						.getType(EvidenceAssertationDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createClaim_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ARMVisualIDRegistry.getType(ClaimEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5004 = createLabel(node,
				ARMVisualIDRegistry.getType(ClaimDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createArgumentReasoning_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5006 = createLabel(
				node,
				ARMVisualIDRegistry
						.getType(ArgumentReasoningDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createInformationElement_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5008 = createLabel(
				node,
				ARMVisualIDRegistry
						.getType(InformationElementDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createCitiationElement_2005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5010 = createLabel(node,
				ARMVisualIDRegistry
						.getType(CitiationElementDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createArgument_2006(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ARMVisualIDRegistry.getType(ArgumentEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5012 = createLabel(node,
				ARMVisualIDRegistry
						.getType(ArgumentDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createAssertedInference_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(ARMVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createAssertedContext_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createAssertedEvidence_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
