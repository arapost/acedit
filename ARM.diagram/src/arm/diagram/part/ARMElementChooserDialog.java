 ...
 * @generated
 */
public class ARMElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ARMElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.ARMElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "arm".equals(fileExtension); //$NON-NLS-1$
	}
