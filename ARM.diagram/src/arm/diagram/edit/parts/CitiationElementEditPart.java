...
import arm.diagram.edit.policies.CitiationElementItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CitiationElementEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CitiationElementEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CitiationElementItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CitiationElementFigure();
	}

	/**
	 * @generated
	 */
	public CitiationElementFigure getPrimaryShape() {
		return (CitiationElementFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CitiationElementIdentifierEditPart) {
			((CitiationElementIdentifierEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCitiationElementLabelFigure());
			return true;
		}
		if (childEditPart instanceof CitiationElementDescriptionEditPart) {
			((CitiationElementDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arm.diagram.edit.parts.CitiationElementEditPart) {
			types.add(ARMElementTypes.AssertedInference_4001);
		}
	 ...
	 * @generated
	 */
	public class CitiationElementFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureCitiationElementLabelFigure;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureCitiationElementLabelFigure = new WrappingLabel();
			fFigureCitiationElementLabelFigure.setText("CitiationElement");

			this.add(fFigureCitiationElementLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCitiationElementLabelFigure() {
			return fFigureCitiationElementLabelFigure;
		}
