...
/**
 * This is the item provider adapter for a {@link GSN1.Solution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolutionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Solution_visibility_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Solution_visibility_feature", "_UI_Solution_type"),
				 GSN1Package.Literals.SOLUTION__VISIBILITY,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Solution.class)) {
			case GSN1Package.SOLUTION__VISIBILITY:
