...
/**
 * This is the item provider adapter for a {@link GSN1.ModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelElement_identifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelElement_identifier_feature", "_UI_ModelElement_type"),
				 GSN1Package.Literals.MODEL_ELEMENT__IDENTIFIER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GSN1Package.Literals.MODEL_ELEMENT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GSN1Package.Literals.MODEL_ELEMENT__CONTAINS_ADDITIONAL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GSN1Package.Literals.MODEL_ELEMENT__CONTAINS_ADDITIONAL,
				 GSN1Factory.eINSTANCE.createTaggedValue()));
	}
