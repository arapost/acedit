 ...
 * <ul>
 *   <li>{@link GSN1.impl.SolutionImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SolutionImpl extends SpinalElementImpl implements Solution {
	/**
	...
	protected EClass eStaticClass() {
		return GSN1Package.Literals.SOLUTION;
	}
	...
	public void setVisibility(ElementVisibility newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GSN1Package.SOLUTION__VISIBILITY, oldVisibility, visibility));
	}
