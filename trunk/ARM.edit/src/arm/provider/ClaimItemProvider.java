...
/**
 * This is the item provider adapter for a {@link arm.Claim} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Claim_assumed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Claim_assumed_feature", "_UI_Claim_type"),
	...
	protected void addToBeSupportedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Claim_toBeSupported_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Claim_toBeSupported_feature", "_UI_Claim_type"),
