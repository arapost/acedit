...
import arm.diagram.edit.commands.ARMCreateShortcutDecorationsCommand;
import arm.diagram.edit.policies.CaseCanonicalEditPolicy;
import arm.diagram.edit.policies.CaseItemSemanticEditPolicy;
...
public class CaseEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "ARM"; //$NON-NLS-1$
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new ARMCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
