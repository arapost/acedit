...
import arm.diagram.edit.policies.ArgumentItemSemanticEditPolicy;
...
public class ArgumentEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ArgumentDescriptionEditPart) {
			((ArgumentDescriptionEditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arm.diagram.edit.parts.ArgumentEditPart) {
			types.add(ARMElementTypes.AssertedInference_4001);
		}
		if (targetEditPart instanceof EvidenceAssertationEditPart) {
			types.add(ARMElementTypes.AssertedContext_4002);
