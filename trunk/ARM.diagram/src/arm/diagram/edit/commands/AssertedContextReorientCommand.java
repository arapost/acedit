 ...
 * @generated
 */
public class AssertedContextReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof AssertedContext) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return ARMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssertedContext_4002(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Case container = (Case) getLink().eContainer();
		return ARMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssertedContext_4002(container, getLink(), source,
						getNewTarget());
	}
	...
	protected AssertedContext getLink() {
		return (AssertedContext) getElementToEdit();
	}
