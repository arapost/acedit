 ...
 * @generated
 */
public class AssertedEvidenceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AssertedEvidenceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof AssertedEvidence) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return ARMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssertedEvidence_4003(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Case container = (Case) getLink().eContainer();
		return ARMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssertedEvidence_4003(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected AssertedEvidence getLink() {
		return (AssertedEvidence) getElementToEdit();
	}
