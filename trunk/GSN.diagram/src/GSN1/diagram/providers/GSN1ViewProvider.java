 ...
 * @generated
 */
public class GSN1ViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return CaseEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = GSN1VisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = GSN1VisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!GSN1ElementTypes.isKnownElementType(elementType)
				...
				if (!CaseEditPart.MODEL_ID.equals(GSN1VisualIDRegistry
		...
		return GoalEditPart.VISUAL_ID == visualID
				...
				|| ArgumentModuleEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = GSN1VisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != GSN1VisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(CaseEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = GSN1VisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = GSN1VisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case GoalEditPart.VISUAL_ID:
		...
		case StrategyEditPart.VISUAL_ID:
			return createStrategy_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case SolutionEditPart.VISUAL_ID:
			return createSolution_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case ContextEditPart.VISUAL_ID:
			return createContext_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case JustificationEditPart.VISUAL_ID:
			return createJustification_2005(domainElement, containerView,
					index, persisted, preferencesHint);
		case AssumptionEditPart.VISUAL_ID:
			return createAssumption_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case ContractEditPart.VISUAL_ID:
			return createContract_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case ArgumentModuleEditPart.VISUAL_ID:
			return createArgumentModule_2008(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (GSN1VisualIDRegistry.getVisualID(elementTypeHint)) {
		case SolvedUsingContractEditPart.VISUAL_ID:
			return createSolvedUsingContract_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case SolvedByEditPart.VISUAL_ID:
			return createSolvedBy_4002(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InContextOfEditPart.VISUAL_ID:
			return createInContextOf_4003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	...
	public Node createGoal_2001(EObject domainElement, View containerView,
		...
		node.setType(GSN1VisualIDRegistry.getType(GoalEditPart.VISUAL_ID));
		...
		Node label5002 = createLabel(node,
				GSN1VisualIDRegistry.getType(GoalDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createStrategy_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry.getType(StrategyEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5004 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(StrategyDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createSolution_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry.getType(SolutionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5006 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(SolutionDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createContext_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry.getType(ContextEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5008 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(ContextDescriptionEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createJustification_2005(EObject domainElement,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry
		...
		Node label5010 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(JustificationDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createAssumption_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry.getType(AssumptionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createContract_2007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry.getType(ContractEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5014 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(ContractDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createArgumentModule_2008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry
				.getType(ArgumentModuleEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5016 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(ArgumentModuleDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createSolvedUsingContract_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(GSN1VisualIDRegistry
				.getType(SolvedUsingContractEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createSolvedBy_4002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(GSN1VisualIDRegistry.getType(SolvedByEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createInContextOf_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(GSN1VisualIDRegistry
				.getType(InContextOfEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	...
	private void stampShortcut(View containerView, Node target) {
		if (!CaseEditPart.MODEL_ID.equals(GSN1VisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", CaseEditPart.MODEL_ID); //$NON-NLS-1$
