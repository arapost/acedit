...
import GSN1.diagram.part.GSN1DiagramEditorUtil;

/**
 * @generated
 */
public class GSN1MarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = GSN1DiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			GSN1DiagramEditorUtil.selectElementsInDiagram(editor,
