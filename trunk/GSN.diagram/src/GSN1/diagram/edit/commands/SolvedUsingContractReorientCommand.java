 ...
 * @generated
 */
public class SolvedUsingContractReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SolvedUsingContractReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SolvedUsingContract) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GSN1BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSolvedUsingContract_4001(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		DecomposableSpinalElement container = (DecomposableSpinalElement) getLink()
				.eContainer();
		return GSN1BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSolvedUsingContract_4001(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected SolvedUsingContract getLink() {
		return (SolvedUsingContract) getElementToEdit();
	}
