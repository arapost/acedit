...
public class InContextOfReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		ContextualElement target = getLink().getContextualElement();
		...
		return GSN1BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInContextOf_4003(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		if (!(oldEnd instanceof ContextualElement && newEnd instanceof ContextualElement)) {
			return false;
		}
		...
		DecomposableSpinalElement container = (DecomposableSpinalElement) getLink()
				.eContainer();
		return GSN1BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInContextOf_4003(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ContextualElement getOldTarget() {
		return (ContextualElement) oldEnd;
	}

	/**
	 * @generated
	 */
	protected ContextualElement getNewTarget() {
		return (ContextualElement) newEnd;
	}
}
