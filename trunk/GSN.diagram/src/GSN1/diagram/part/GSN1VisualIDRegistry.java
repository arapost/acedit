...
public class GSN1VisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case CaseEditPart.VISUAL_ID:
			...
			if (GSN1Package.eINSTANCE.getContract().isSuperTypeOf(
					domainElement.eClass())) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case ContractEditPart.VISUAL_ID:
			if (ContractIdentifierEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (GSN1Package.eINSTANCE.getSolvedUsingContract().isSuperTypeOf(
				domainElement.eClass())) {
			return SolvedUsingContractEditPart.VISUAL_ID;
		}
