...
/**
 * This is the item provider adapter for a {@link GSN1.DecomposableSpinalElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DecomposableSpinalElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GSN1Package.Literals.DECOMPOSABLE_SPINAL_ELEMENT__TO_BE_DEVELOPED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GSN1Package.Literals.DECOMPOSABLE_SPINAL_ELEMENT__CHILD_SOLVED_BY);
			childrenFeatures.add(GSN1Package.Literals.DECOMPOSABLE_SPINAL_ELEMENT__HAS_CONTEXT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GSN1Package.Literals.DECOMPOSABLE_SPINAL_ELEMENT__CHILD_SOLVED_BY,
				 GSN1Factory.eINSTANCE.createSolvedBy()));

		newChildDescriptors.add
			(createChildParameter
				(GSN1Package.Literals.DECOMPOSABLE_SPINAL_ELEMENT__HAS_CONTEXT,
				 GSN1Factory.eINSTANCE.createInContextOf()));
	}
