...
/**
 * This is the item provider adapter for a {@link GSN1.Goal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GoalItemProvider
	extends DecomposableSpinalElementItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Goal_visibility_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Goal_visibility_feature", "_UI_Goal_type"),
				 GSN1Package.Literals.GOAL__VISIBILITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GSN1Package.Literals.GOAL__TO_BE_SUPPORTED_BY_CONTRACT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
