...
public class GSN1AdapterFactory extends AdapterFactoryImpl {
	...
	protected GSN1Switch<Adapter> modelSwitch =
		new GSN1Switch<Adapter>() {
			...
			@Override
			public Adapter caseSolvedUsingContract(SolvedUsingContract object) {
				return createSolvedUsingContractAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseInheritedContext(InheritedContext object) {
				return createInheritedContextAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link GSN1.SolvedUsingContract <em>Solved Using Contract</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSolvedUsingContractAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link GSN1.Contract <em>Contract</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link GSN1.InheritedContext <em>Inherited Context</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInheritedContextAdapter() {
		return null;
	}
