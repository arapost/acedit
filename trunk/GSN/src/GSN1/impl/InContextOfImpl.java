...
public class InContextOfImpl extends EObjectImpl implements InContextOf {
	 ...
	 * @ordered
	 */
	protected ContextualElement contextualElement;
	 ...
	 * @generated
	 */
	public ContextualElement getContextualElement() {
		if (contextualElement != null && contextualElement.eIsProxy()) {
			...
			contextualElement = (ContextualElement)eResolveProxy(oldContextualElement);
	 ...
	 * @generated
	 */
	public ContextualElement basicGetContextualElement() {
		return contextualElement;
	}
	 ...
	 * @generated
	 */
	public void setContextualElement(ContextualElement newContextualElement) {
		ContextualElement oldContextualElement = contextualElement;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case GSN1Package.IN_CONTEXT_OF__CONTEXTUAL_ELEMENT:
				setContextualElement((ContextualElement)newValue);
				return;
			case GSN1Package.IN_CONTEXT_OF__CONTEXT_OF_SPINAL_ELEMENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case GSN1Package.IN_CONTEXT_OF__CONTEXTUAL_ELEMENT:
				setContextualElement((ContextualElement)null);
				return;
			case GSN1Package.IN_CONTEXT_OF__CONTEXT_OF_SPINAL_ELEMENT:
