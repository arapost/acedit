 ...
 *   <li>{@link GSN1.impl.AwayGoalImpl#getModuleIdentifier <em>Module Identifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AwayGoalImpl extends SpinalElementImpl implements AwayGoal {
	...
	public void setModuleIdentifier(String newModuleIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GSN1Package.AWAY_GOAL__MODULE_IDENTIFIER, oldModuleIdentifier, moduleIdentifier));
	}
