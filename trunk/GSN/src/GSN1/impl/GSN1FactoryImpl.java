...
public class GSN1FactoryImpl extends EFactoryImpl implements GSN1Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case GSN1Package.SOLVED_USING_CONTRACT: return createSolvedUsingContract();
			case GSN1Package.CONTRACT: return createContract();
			case GSN1Package.INHERITED_CONTEXT: return createInheritedContext();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case GSN1Package.ELEMENT_STATUS:
				return createElementStatusFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case GSN1Package.ELEMENT_STATUS:
				return convertElementStatusToString(eDataType, instanceValue);
			case GSN1Package.ELEMENT_VISIBILITY:
	 ...
	 * @generated
	 */
	public SolvedUsingContract createSolvedUsingContract() {
		SolvedUsingContractImpl solvedUsingContract = new SolvedUsingContractImpl();
		return solvedUsingContract;
	}
	 ...
	 * @generated
	 */
	public InheritedContext createInheritedContext() {
		InheritedContextImpl inheritedContext = new InheritedContextImpl();
	 ...
	 * @generated
	 */
	public ElementStatus createElementStatusFromString(EDataType eDataType, String initialValue) {
		ElementStatus result = ElementStatus.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertElementStatusToString(EDataType eDataType, Object instanceValue) {
