 ...
 * @generated
 */
public class GSN1ElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public GSN1ElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.GSN1ElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "GSN1".equals(fileExtension); //$NON-NLS-1$
	}
