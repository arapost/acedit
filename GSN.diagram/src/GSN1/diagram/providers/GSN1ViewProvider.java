...
public class GSN1ViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return GoalEditPart.VISUAL_ID == visualID
				...
				|| AwayGoalEditPart.VISUAL_ID == visualID
				...
				|| AwayContextEditPart.VISUAL_ID == visualID
				|| AwaySolutionEditPart.VISUAL_ID == visualID
				|| ArgumentModuleEditPart.VISUAL_ID == visualID
				|| ContractModuleEditPart.VISUAL_ID == visualID;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case StrategyEditPart.VISUAL_ID:
			return createStrategy_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case AwayGoalEditPart.VISUAL_ID:
			return createAwayGoal_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case SolutionEditPart.VISUAL_ID:
			return createSolution_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case ContextEditPart.VISUAL_ID:
			return createContext_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case JustificationEditPart.VISUAL_ID:
		...
		case AssumptionEditPart.VISUAL_ID:
			return createAssumption_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case AwayContextEditPart.VISUAL_ID:
			return createAwayContext_2008(domainElement, containerView, index,
					persisted, preferencesHint);
		case AwaySolutionEditPart.VISUAL_ID:
			return createAwaySolution_2009(domainElement, containerView, index,
					persisted, preferencesHint);
		case ArgumentModuleEditPart.VISUAL_ID:
			return createArgumentModule_2010(domainElement, containerView,
					index, persisted, preferencesHint);
		case ContractModuleEditPart.VISUAL_ID:
			return createContractModule_2011(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case SolvedByModularEditPart.VISUAL_ID:
			return createSolvedByModular_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case InContextOfModularEditPart.VISUAL_ID:
			return createInContextOfModular_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case SolvedByEditPart.VISUAL_ID:
			return createSolvedBy_4003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InContextOfEditPart.VISUAL_ID:
			return createInContextOf_4004(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createAwayGoal_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry.getType(AwayGoalEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5005 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(AwayGoalIdentifierEditPart.VISUAL_ID));
		Node label5006 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(AwayGoalDescriptionEditPart.VISUAL_ID));
		Node label5007 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(AwayGoalModuleIdentifierEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createSolution_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createContext_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createAwayContext_2008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry
				.getType(AwayContextEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5017 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(AwayContextDescriptionEditPart.VISUAL_ID));
		Node label5018 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(AwayContextModuleIdentifierEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createAwaySolution_2009(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry
				.getType(AwaySolutionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5020 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(AwaySolutionDescriptionEditPart.VISUAL_ID));
		Node label5021 = createLabel(
				node,
				GSN1VisualIDRegistry
						.getType(AwaySolutionModuleIdentifierEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createArgumentModule_2010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createContractModule_2011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GSN1VisualIDRegistry
				.getType(ContractModuleEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5025 = createLabel(node,
				GSN1VisualIDRegistry
						.getType(ContractModuleDescriptionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createSolvedByModular_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(GSN1VisualIDRegistry
				.getType(SolvedByModularEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createInContextOfModular_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(GSN1VisualIDRegistry
				.getType(InContextOfModularEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createSolvedBy_4003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label6001 = createLabel(edge,
				GSN1VisualIDRegistry
						.getType(SolvedByCardinalityEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createInContextOf_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
