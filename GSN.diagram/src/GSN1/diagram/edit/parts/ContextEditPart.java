...
import GSN1.diagram.edit.policies.ContextItemSemanticEditPolicy;
...
public class ContextEditPart extends ShapeNodeEditPart {
	...
	protected void handleNotificationEvent(Notification event) {
		if (event.getNotifier() == getModel()
			...
			if (event.getNotifier() instanceof Context) {
				...
				Context context = (Context) ((Node) this.getModel())
						.getElement();

				if (context.getTobeinstantiated() == true) {
					ContextFigure figure = (ContextFigure) this
							.getPrimaryShape();
					figure.setShape(1);
				} else {
					ContextFigure figure = (ContextFigure) this
	...
	public class ContextFigure extends GSNContext {
		...
		private void createContents() {
			...
			fFigureContextLabelFigure.setFont(FFIGURECONTEXTLABELFIGURE_FONT);
	 ...
	 * @generated
	 */
	static final Font FFIGURECONTEXTLABELFIGURE_FONT = new Font(
