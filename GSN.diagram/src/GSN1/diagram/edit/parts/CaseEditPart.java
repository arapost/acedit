...
import GSN1.diagram.edit.commands.GSN1CreateShortcutDecorationsCommand;
import GSN1.diagram.edit.policies.CaseCanonicalEditPolicy;
import GSN1.diagram.edit.policies.CaseItemSemanticEditPolicy;

/**
 * @generated
 */
public class CaseEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "GSN1"; //$NON-NLS-1$
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new GSN1CreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
