...
import gsnfigures.GSNArgumentModule;
...
import GSN1.diagram.edit.policies.ArgumentModuleItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ArgumentModuleEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ArgumentModuleEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ArgumentModuleItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ArgumentModuleFigure();
	}

	/**
	 * @generated
	 */
	public ArgumentModuleFigure getPrimaryShape() {
		return (ArgumentModuleFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ArgumentModuleIdentifierEditPart) {
			((ArgumentModuleIdentifierEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureArgumentModuleLabelFigure());
			return true;
		}
		if (childEditPart instanceof ArgumentModuleDescriptionEditPart) {
			((ArgumentModuleDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof GSN1.diagram.edit.parts.ArgumentModuleEditPart) {
			types.add(GSN1ElementTypes.SolvedByModular_4001);
		}
	 ...
	 * @generated
	 */
	public class ArgumentModuleFigure extends GSNArgumentModule {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureArgumentModuleLabelFigure;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureArgumentModuleLabelFigure = new WrappingLabel();
			fFigureArgumentModuleLabelFigure.setText("ArgumentModule");

			fFigureArgumentModuleLabelFigure
					.setFont(FFIGUREARGUMENTMODULELABELFIGURE_FONT);

			this.add(fFigureArgumentModuleLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureArgumentModuleLabelFigure() {
			return fFigureArgumentModuleLabelFigure;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREARGUMENTMODULELABELFIGURE_FONT = new Font(
